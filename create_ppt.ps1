...
try {
    ...
    # Some environments don't allow setting visible if running unattended, but let's try
    ...
    $pic1 = $slide2.Shapes.AddPicture("C:\Users\hongwon\.gemini\antigravity\brain\bac4be59-d96a-4c7f-b2d9-84a180be5df4\tablet_app_mockup_1_1779955904459.png", $false, $true, 400, 120, 500, 350)
    ...
    $pic2 = $slide3.Shapes.AddPicture("C:\Users\hongwon\.gemini\antigravity\brain\bac4be59-d96a-4c7f-b2d9-84a180be5df4\tablet_app_mockup_2_1779955922790.png", $false, $true, 400, 120, 500, 350)

    # Save
    $savePath = "c:\Users\hongwon\Desktop\발주시스템\출퇴근_웹앱\시스템_메뉴얼.pptx"
